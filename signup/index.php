                ...
                if ($stmt->execute()) {
                    ...
                    if ($token_stmt->execute()) {
                        ...
                        try {
                            ...
                            $mail->Body = 'Thank you for registering! Please click on the following link to verify your email address: <b><a href="http://localhost/mdm/verify/?token=' . $token . '">http://localhost/mdm/verify/?token=' . $token . '</a></b>';
